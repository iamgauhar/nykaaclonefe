...
let Products_Container = document.querySelector(".NykaaCosProducts-Container")
  ...
  getAllProducts();
   async function getAllProducts(){
      const res  = await fetch(`https://rich-gray-dolphin-hat.cyclic.app/products`)//("http://localhost:8000/products")
...
async function addToCart(prod){
  ...
  try{
    let cart_data = await fetch(`https://rich-gray-dolphin-hat.cyclic.app/cart/productData/${productId}` , {
      headers : {
    ...
    try {
      ...
      await fetch(`https://rich-gray-dolphin-hat.cyclic.app/cart/add`, {
        method: "POST",
